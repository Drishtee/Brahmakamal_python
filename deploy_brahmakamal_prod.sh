...
APP_DIR="/home/hybridadmin/Brahmakamal_python_prod"
BRANCH="prod"
SERVICE="brahmakamal-prod.service"
VENV="$APP_DIR/venv"
URL="https://brahmakamal.drishtee.in/auth/login"

echo "=========================================="
echo " Brahmakamal Production Deployment"
echo "=========================================="
...
echo ""
echo "[3/9] Fetching latest production code..."
...
echo ""
echo "Production commit: $DEPLOYED_COMMIT"
...
echo ""
echo "[7/9] Restarting production service..."
...
echo ""
echo "[8/9] Checking production application endpoint..."
